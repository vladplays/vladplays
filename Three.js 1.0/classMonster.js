class Monster{
	...
	II(input){
		...
		console.log(!document.getElementById(this.x+','+this.y).innerHTML)
		if(this.x==oldX&&this.y==oldY){
			this.II(Math.floor(Math.random()*4))
			return;
		}
	...
	init3D(){
		...
		this.y=2
		this.remove()
		let monster3d=new Monster3D(['monster-dog', 'monster-dog-down-two pos'],1);
