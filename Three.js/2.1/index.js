//try{
	...
	document.getElementById('yes').onclick=function(){
		...
		loadModel('/knopka.glb', function(object){
			...
			/*let lightTest = new THREE.SpotLight(0xFFFFFF);
			let lightTestH = new THREE.SpotLightHelper(lightTest);
			lightTest.position.set(object.position.x,object.position.y,object.position.z+5);
			lightTest.lookAt(object)*/
			object.scale.set(0.3,0.3,0.3)
			scene.add(object);
			/*scene.add(lightTest);
			scene.add(lightTestH);*/
		...
		render.domElement.onclick=function(event){
			//controls.lock()
