class Monster{
	...
	init3D(){
		...
		let monster3d
		if(this.type=='normal')
			monster3d = new Monster3D(['monster-dog', 'monster-dog-down-two pos']);
		else
			monster3d = new Monster3D(['monster-dog blend', 'monster-dog-down-two pos blend']);
	...
	init(){
		...
		if(amounts.video==levelObj.durabilityTools.video){
